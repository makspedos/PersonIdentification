...
class MyModel:
    def __init__(self):
        self.age_model = load_model(r'C:\Users\maksp\PycharmProjects\face_recognision\breed_project\models\age\age.h5')
        self.gender_model = load_model(r'C:\Users\maksp\PycharmProjects\face_recognision\breed_project\models\gender\gender-model.h5')
        self.emotion_model = load_model(r'C:\Users\maksp\PycharmProjects\face_recognision\breed_project\models\emotion\emotion.h5')
        self.cascade = cv2.CascadeClassifier('C:/Users/maksp/PycharmProjects/face_recognision/haarcascade_frontalface_default.xml')
